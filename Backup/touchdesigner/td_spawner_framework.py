...
class BirthdaySpawner:
    ...
    def apply_static_data(self, comp, submission):
        self.set_text_child(comp, "name_text", submission.name)
        self.set_text_child(comp, "message_text", submission.message)
        self.set_file_child(comp, "photo", submission.image_path())
        ...
        self.set_custom_or_param(comp, "Imagepath", submission.image_path())
        self.set_custom_or_param(comp, "Imageurl", submission.image_url())
    ...
    def write_database_table(self):
        ...
        table.clear()
        table.appendRow(["id", "timestamp", "name", "message", "image", "image_path", "device"])
    ...
    def write_queue_table(self):
        ...
        table.clear()
        table.appendRow(["queue_index", "id", "name", "message", "image_path"])
        for index, submission in enumerate(self.queue):
            table.appendRow([index, submission.id, submission.name, submission.message, submission.image_path()])
